const moodsEndPoint = 'https://dope-cocktail-menu-api.herokuapp.com/api/v1/moods'
const cocktailsEndPoint = 'https://dope-cocktail-menu-api.herokuapp.com/api/v1/cocktails'
const likesEndPoint = 'https://dope-cocktail-menu-api.herokuapp.com/api/v1/likes'
const commentsEndPoint = 'https://dope-cocktail-menu-api.herokuapp.com/api/v1/comments'
